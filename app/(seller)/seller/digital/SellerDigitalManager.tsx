  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ marginBottom: 24, display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
        ...
        <button onClick={() => window.location.href = "/seller/digital/studio"} style={{ padding: "9px 18px", background: "linear-gradient(135deg,#ef4444,#dc2626)", border: "none", borderRadius: 12, color: "#fff", fontWeight: 700, fontSize: "0.83rem", cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}>
        ...
        <div>
          {products.length === 0 ? (
            <div style={{ textAlign: "center", padding: "60px 20px", background: "rgba(255,255,255,0.03)", borderRadius: 16, border: "2px dashed rgba(255,255,255,0.1)" }}>
              ...
              <button onClick={() => window.location.href = "/seller/digital/studio"} style={{ padding: "9px 22px", background: "linear-gradient(135deg,#ef4444,#dc2626)", border: "none", borderRadius: 12, color: "#fff", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer" }}>
                    ...
                    <div style={{ padding: "16px 18px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
                        ...
                        <div style={{ display: "flex", gap: 6, flexShrink: 0, marginLeft: 8 }}>
                          <button onClick={() => window.location.href = `/seller/digital/studio?id=${p.id}`} style={{ padding: "3px 10px", borderRadius: 999, fontSize: "0.65rem", fontWeight: 700, background: "rgba(255,255,255,0.1)", color: "#fff", border: "none", cursor: "pointer" }}>
